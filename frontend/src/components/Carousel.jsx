    ...
    return (
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" style={{objectFit:"contain !important"}}>
            ...
            <div className="carousel-inner" id="carousel" >
                ...
                <div className="carousel-item active" style={{objectFit:"contain !important", backgroundSize: "contain", backgroundRepeat: "no-repeat", backgroundPosition: "center", height: "50%"}}>
                    <img src="https://source.unsplash.com/random/900×700/?burger" className="d-block w-100" style={{filter:"brightness(30%)"}} alt="..." />
                </div>
                <div className="carousel-item" style={{objectFit:"contain !important", backgroundSize: "contain", backgroundRepeat: "no-repeat", backgroundPosition: "center", height: "700px"}}>
